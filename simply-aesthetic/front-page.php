...
<section class="main">
    ...
    <div class="main__column">
		...
		<img class="image_mobile" src="<?php echo $main['image_mobile']; ?>" alt="">
    </div>
</section>
<?php } ?>
...
<section class="benefits">
    ...
    <div class="benefits__column">
        <div class="benefits__title"><?php echo $benefits['title']; ?></div>
...
<section class="reviews">
	...
	<div class="reviews__slider">
		...
		<button type="button" class="swiper-button-prevr _icon-arrow-2"></button>
    	<button type="button" class="swiper-button-nextr _icon-arrow-2"></button>
	</div>
    <?php } ?>
</section>
<?php } ?>
...
<?php } ?>
	...
	<script type="application/ld+json">
	{
	  ...
	  "name": "Simply Aesthetic",
	  "url": "https://simplyaesthetic.co.uk/",
	  "logo": {
		"@type": "ImageObject",
		"url": "https://simplyaesthetic.co.uk/wp-content/uploads/2022/06/logo_green.svg"
	  },
	  "sameAs": [
		"https://www.linkedin.com/company/simply-aesthetic-turkey/",
		"https://www.instagram.com/simply_aesthetic_turkey/",
		"https://x.com/simplyaesthet1c",
		"https://www.facebook.com/simplyaestheticgroup",
		"https://www.tiktok.com/@simply_aesthetic_turkey",
		"https://uk.trustpilot.com/review/simplyaesthetic.co.uk",
		"https://www.crunchbase.com/organization/simply-aesthetic"
	  ],
	  "address": [
		{
		  "@type": "PostalAddress",
		  "streetAddress": "Simply Aesthetic, Workington, Halaskargazi, Halaskargazi Cd. No: 38-66",
		...
		{
		  "@type": "PostalAddress",
		  "streetAddress": "Forma House, 40 Bowling Green Lane",
	  ...
	  "legalName": "Simply Aesthetic Group Ltd.",
	  "identifier": {
		"@type": "PropertyValue",
		"name": "Company Registration Number",
		"value": "14106659",
		"url": "https://find-and-update.company-information.service.gov.uk/company/14106659"
	  },
	  "publishingPrinciples": {
		"@type": "CreativeWork",
		"name": "Simply Aesthetic Editorial Guidelines",
		"url": "https://simplyaesthetic.co.uk/editorial-guidelines/"
	  }
	}
	</script>
